...
enum Currency: String, HandyJSONEnum {
    ...
    static let supportCurrency : [Currency] = [    .AUD, .BGN, .BRL, .CAD, .CHF,
                                                   .CNY, .CZK, .DKK, .GBP, .HKD,
                                                   .HRK, .HUF, .IDR, .ILS, .INR,
                                                   .JPY, .KRW, .MXN, .MYR, .NOK,
                                                   .NZD, .PHP, .PLN, .RON, .RUB,
...
//class CurrencyResource: NSObject {
//   class func symbol(currency: Currency) -> String? {
//        switch currency {
//        case .AUD:
//            return "$"
//        case .BGN:
...
//    }
//
//    class func image(currency: Currency) -> UIImage? {
//        switch currency {
//        case .AUD:
//            return UIImage(named: "234-australia")
//        case .BGN:
